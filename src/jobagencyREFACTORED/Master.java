...
public class Master implements Observer {
    ...
    public void receiveOffer(String nameCompany, int salary) {
        makeDecision(nameCompany, salary);
    }

    private void makeDecision(String nameCompany, int salary){
        if (salary < 80){
...
/*
 * Класс Master теперь отвечает только за принятие решения на основе предложения о работе, что соответствует принципу Single Responsibility.
 */